...
def process_pdfs_in_folder(folder_path,excel_file_path):
    ...
    for file_name in os.listdir(folder_path):
        if file_name.endswith(".pdf"):
            ...
            txt_process_folder(txt_output_path,excel_file_path,corrected_text)
...
def extract_student_data(file_path, user_certificate,text):
    ...
    result = check_strings_in_text(text_simple, student_name, HsRegNo)
...
def txt_process_folder(folder_path,excel_file_path,text):    
